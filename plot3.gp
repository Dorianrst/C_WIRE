...
set output 'Graphs\bar_chart4.png'  # Nom du fichier de sortie
...
set xlabel "Station LV PARTICULIER"  # Légende de l'axe des X
set ylabel "Load"  # Légende de l'axe des Y
set grid ytics  # Activer la grille sur l'axe Y

# Tracer le graphique à barres
plot 'LV_particulier.dat' using 1:2 with boxes title 'Charge'

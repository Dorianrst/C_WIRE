...
echo "Liste des stations" > final_output.csv

# Filtrer et extraire les informations nécessaires (ici on suppose que chaque ligne contient 'Station' suivi des données)
awk '/Station/ {print $0}' output.csv >> final_output.csv

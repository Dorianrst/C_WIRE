...
set output 'Graphs\bar_chart5.png'  # Nom du fichier de sortie
...
set xlabel "Station LV COMPANY"  # Légende de l'axe des X
set ylabel "Load"  # Légende de l'axe des Y
set grid ytics  # Activer la grille sur l'axe Y

# Tracer le graphique à barres
plot 'LV_company.dat' using 1:2 with boxes title 'Charge'

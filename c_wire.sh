...
filter() {
    ...
    #This condition is used to check whether I am passing an argument in station where there are three types of argument HVB / HVA / LV if there is no argument, I display that there is no argument and stop the program.
    if [ $# -eq 0 ]; then
